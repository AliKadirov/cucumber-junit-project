Feature: Web table user order feature
  ...
  Scenario Template: User should be able to place order and order seen in web table with using DDT
    ...
    Examples: Famous male scientist
      | productType | quantity | customerName      | street              | city   | state   | zipCode | cardType | cardNumber       | expiryDate | expectedName      |
      | Familybea   | 2        | Albert Einstein   | 21B Baker Street    | London | England | 50505   | visa     | 9111222203334440 | 12/23      | Albert Einstein   |
      | MoneyCog    | 4        | Alfred Nobel      | 223B Austin Street  | London | England | 50505   | visa     | 9311222203334441 | 12/23      | Alfred Nobel      |
      | Screenable  | 2        | Charles Darwin    | 298B Jackson Street | London | England | 50505   | visa     | 9011222203334442 | 12/23      | Charles Darwin    |
      | MoneyCog    | 3        | Carl Sagan        | 244B Ba Street      | London | England | 50505   | visa     | 9811222203334443 | 12/23      | Carl Sagan        |
      | Familybea   | 1        | Archimedes        | 222B Bride Street   | London | England | 50505   | visa     | 9611222203334444 | 12/23      | Archimedes        |
      | Screenable  | 2        | Alexander Flaming | 2201B Son Street    | London | England | 50505   | visa     | 9111222233334445 | 12/23      | Alexander Flaming |
