...
public class VyTrackLoginDDTTest {
    ...
    public void loginDDTTest() throws IOException {
        ...
        String filePath = "C:\\Users\\Mali\\IdeaProjects\\cucumber-junit-project\\SampleData.xlsx";
        ...
        for (int i = 1; i < sheet.getLastRowNum(); i++) {
            ...
            WebElement loaderMask = Driver.getDriver().findElement(By.xpath("//div[@class='progress progress-striped active']"));
